...
final class Cache
{
  ...
  public static function get_full_cache()
  {
  ...
  public static function delete_old_full_caches()
  {
    $old_caches = glob('./app/_cache/pages/all-content-*');
    foreach ($old_caches as $file) unlink($file);
  }

  public static function save_full_cache($full_cache, $hash)
  {
  ...
  public static function create_full_cache($pages = null)
  {
